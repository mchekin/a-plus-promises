...
use Mchekin\APlusPromises as P;
use Mchekin\APlusPromises\AggregateException;
use Mchekin\APlusPromises\FulfilledPromise;
use Mchekin\APlusPromises\Promise;
use Mchekin\APlusPromises\PromiseInterface;
use Mchekin\APlusPromises\RejectedPromise;
...
class FunctionsTest extends TestCase
{
    ...
    /**
     * @expectedException \Mchekin\APlusPromises\RejectionException
     */
    ...
    /**
     * @expectedException \Mchekin\APlusPromises\AggregateException
    ...
    public function testAsyncPromisesWithCorrectlyYieldedValues()
    {
        ...
        eval('
        $promise = \Mchekin\APlusPromises\coroutine(function () use ($promises) {
            $value = null;
            $this->assertEquals(\'skip\', (yield new \Mchekin\APlusPromises\FulfilledPromise(\'skip\')));

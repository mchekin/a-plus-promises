...
use Mchekin\APlusPromises\CancellationException;
...
/**
 * @covers Mchekin\APlusPromises\Promise
 */
class PromiseTest extends TestCase
{
    ...
    /**
     * @expectedException \Mchekin\APlusPromises\CancellationException
     */
    ...
    public function testCreatesPromiseWhenFulfilledBeforeThen()
    {
        ...
        \Mchekin\APlusPromises\queue()->run();
        $this->assertEquals('foo', $carry);
    }
